  ...
  <div id="manageTransactions">
    <div id="control">
      ...
      <router-link v-bind:to="{ name: 'NewTransaction' }">
        <button class="transaction__button">Add New Transaction</button>
      </router-link>
      <button class="transaction__button" @click=deleteAll()>Delete All Transactions</button>
      <section class="importExport">
        <button class="transaction__button right" @click=getCsvReport()>Export All Transactions</button>
        <button class="transaction__button right" onclick="document.getElementById('file').click();">Import Transactions</button>
      </section>
  ...
  export default {
    ...
    csvJSON(csv) {
      ...
      lines.map(function(line, indexLine) {
        ...
        var obj = {}
        //FIXME: REGEX TO MATCH TRANSACTION.csv FORMAT
