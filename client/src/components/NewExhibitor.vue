<template>
  <main class="form">
    ...
    <div v-if="this.isDataReady">
      ...
      <input v-validate="'required'" type="text" name="tag" placeholder="Tag*" v-model="tag" autocomplete="off">
      ...
      <router-link v-bind:to="{ name: 'Manage', params: {view: true, view2: false, view3: false } }">
